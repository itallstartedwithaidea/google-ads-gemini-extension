/**
 * Proxy sign-in for the Remote (googleadsagent.ai) backend.
 *
 * The CLI delegates the entire Google OAuth dance to googleadsagent.ai, which
 ...
 *     the opaque sessionId that googleadsagent.ai mints.
 ...
 *
 * @param {Object} opts
 * @param {string} opts.siteUrl       - Base URL of googleadsagent.ai deployment.
